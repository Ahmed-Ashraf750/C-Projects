...
int main()
{
    ...
    if (Present_Date.Month > Max_Months_Per_Year || Present_Date.Month < Zero || Date_Of_Birth.Month > Max_Months_Per_Year || Date_Of_Birth.Month < Zero)
    {
    ...
    if (Present_Date.Day > Max_Days_Per_Month || Present_Date.Day < Zero || Date_Of_Birth.Day > Max_Days_Per_Month || Date_Of_Birth.Day < Zero)
    {
